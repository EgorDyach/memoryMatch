...
const Icon: FC = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g filter="url(#filter0_d_399_1868)">
      <path
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_399_1868"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_399_1868"
          result="shape"
        />
      </filter>
    </defs>
...
const PinkStarIcon = withIcon(Icon);

PinkStarIcon.displayName = "PinkStarIcon";
export default PinkStarIcon;
